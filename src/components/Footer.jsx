        ...
        <div className="container-fluid contFooter">
            ...
            <div className="row footer">
                ...
                <div className="col-12 col-md-4 brand">
                    <h3>THE BRAND</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt minim veniam.
                    </p>
                    <p>Egestas integer eget aliquet nibh praesent tristique sum magna sit amet. Elit eget gravida cum sociis natoque et penatibus et magnis dis. Cras fermentum odio eu feugiat pretium nibh. Sagittis vitae et leo duis.
                    </p>
                </div>
